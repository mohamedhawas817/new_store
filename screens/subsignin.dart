...
class SubSignIn extends StatefulWidget {
  const SubSignIn({Key? key}) : super(key: key);

  @override
  State<SubSignIn> createState() => _LoginState();
}

class _LoginState extends State<SubSignIn> {
  ...
  void submit() async {
    ...
    if(_formkey.currentState!.validate()) {
      ...
      try {
        ...
        Navigator.of(context).pushNamed("supplierhome");
            ...
            children: [
              Padding(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ListTile(
                        title: Text("Sign In to Your store", style: TextStyle(fontSize: 28),),
              ...
              processing == true ? CircularProgressIndicator() : TextButton(
                  ...
                  child: Container(
                    ...
                    child: Center(child: Text("Sign In to Your Store", style: TextStyle(color: Colors.white, fontSize: 20),)),
                  )
              )
